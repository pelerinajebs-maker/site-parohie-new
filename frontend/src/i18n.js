...
const dict = {
  ro: {
    ...
    nav: {
      ...
      catechesis: "Catehizare", prayers: "Rugăciuni", contact: "Contact", donate: "Donează",
    },
    hero: {
  ...
  de: {
    ...
    nav: {
      ...
      catechesis: "Katechese", prayers: "Gebete", contact: "Kontakt", donate: "Spenden",
    },
    hero: {
  ...
  en: {
    ...
    nav: {
      ...
      catechesis: "Catechesis", prayers: "Prayers", contact: "Contact", donate: "Donate",
    },
    hero: {
